...
@section('content')
    ...
    <button class="layui-btn layui-btn-sm" onclick="layer_show('查看','{{route('category.show',['id'=>''])}}')"><i class="layui-icon"></i></button>

    <button class="layui-btn layui-btn-sm" onclick="layer_show('编辑','{{route('category.create')}}')"><i class="layui-icon"></i></button>
    ...
    <script>
        layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function(){
            ...
            table.render({
                ...
                ,id:'testReload'
                ,url: "{{route('category.getData',['id'])}}" //数据接口
                ,page: true //开启分页
